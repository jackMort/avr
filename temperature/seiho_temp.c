...
/**
 * zapis bitu na wyjcie termometru
 */
...
/**
 * odczyt bitu z wyjcia termometru
 */
...
/**
 * Metoda odczytuje temperaturę z czujnika do buffora znaków
...
/**
 * Funkcja inicijalizujšca ekran LCD
 */
void initLCD( void ) {
